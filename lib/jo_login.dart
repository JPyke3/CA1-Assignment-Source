...
void main() => runApp(new My2D2Do());

class My2D2Do extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return new MaterialApp(
        home:
            new LoginPage(), //class for home page; loginpage cannot be used for home parameter, call override below
        theme: new ThemeData(
            //loading theme colors
            primarySwatch: Colors.blue // discord: Logo colour code: #4BACE9
            //Logo colour complement: #E9884B
            //color: const Color(0xff4bace9), (0xffe9884b)
            ));
  }
}
                    ...
                    new Form(
                      child: new Theme(        //wrapping form fields and container with a new widget
                        data: new ThemeData(
                            ...
                            primarySwatch: Colors.teal,//Theme data for colors etc
                            inputDecorationTheme: new InputDecorationTheme(
                                labelStyle: new TextStyle(
                                    color: Color(0xffe9884b), fontSize: 20.0))),
                        child: new Container(
